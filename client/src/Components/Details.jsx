  ...
  return (
    <div className="House__detailContainer">
      {loading ? (
        ...
        <h1>The server is currently under construction :(</h1>
      ) : (
        <div className="col-sm-9 House__details">
          {houseDescription.map((house) => {
            return (
              <div className="House__detail" key={house._id}>
                <img src={house.house_properties.houseImage} alt="House"/>
                <div className="info">
                  <h4 className="house__price">{`AGENT IS:   ${house.owner.name}  ${house.owner.surname}`}</h4>
                  ...
                  <h4 className="house__location">HOUSE DESCRIPTION</h4>
                  <h5 className="house__location">{house.house_properties.description}</h5>
                </div>
      ...
      <div className="col-sm-3 Contact__agentForm">
